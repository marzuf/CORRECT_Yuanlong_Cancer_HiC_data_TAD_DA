...
# Rscript coexpr_between_within_sub.R

script_name <- "coexpr_between_within_sub.R"

startTime <- Sys.time()

cat("> START coexpr_between_within_sub.R \n")
...
outFolder <- "COEXPR_BETWEEN_WITHIN_SUB"
