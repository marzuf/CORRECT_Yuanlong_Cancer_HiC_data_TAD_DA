# Rscript coexpr_DE_analysis_withinOnly.R

script_name <- "coexpr_DE_analysis_withinOnly.R"

startTime <- Sys.time()

cat("> START coexpr_DE_analysis_withinOnly.R \n")
...
outFolder <- "COEXPR_DE_ANALYSIS_WITHINONLY"
...
tad_coexpr_fc_DT <- merge(mC_DT, fc_rd_DT, by=c("dataset", "region"))
