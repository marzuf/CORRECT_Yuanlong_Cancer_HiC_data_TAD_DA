# Rscript check_coexpr_DE_queryTAD_byDS.R

script_name <- "check_coexpr_DE_queryTAD_byDS.R"

startTime <- Sys.time()

cat("> START check_coexpr_DE_queryTAD_byDS.R \n")
...
outFolder <- paste0("CHECK_COEXPR_DE_QUERYTAD_BYDS_", nTop)
